# Currency Converter Wiki

Welcome to the Currency Converter documentation. This wiki contains comprehensive information about the application architecture, development, and deployment.

## Quick Navigation

- [Getting Started](Getting-Started) - Development environment setup
- [Features](Features) - Application capabilities
- [Google Play Submission](Google-Play-Submission) - Publishing guide
- [Icon Creation Guide](Icon-Creation-Guide) - Asset creation
- [Privacy Policy](Privacy-Policy) - Privacy documentation
